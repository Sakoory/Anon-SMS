...
clear
echo -e "\e[4;31m BW Hackers !!! \e[0m"
...
gem install lolcat
echo This Tool Is Created By Sakoory
echo This Script Is Created By Panda Hackers Sakoory >update.pandahackers
...
toilet -f mono12 -F border BW | lolcat
echo -e "\e[1;34mFor Any Queries Mail Us!!!\e[0m"
echo -e "\e[1;34m    Instagram: https://instagram.com/u9t_n \e[0m"
echo " "
...
git clone https://github.com/Sakoory/Anon-SMS.git
...
echo "         [-] Ping At: http://Instagram.com/u9t_n"
echo ""
echo ""
...
toilet -f pagga -F border Sakoory | lolcat
echo " "
exit 0
else
