...
def banner():
    ...
    logo = """                                                  
     ...
     \033[0m██     \033[91m   ╚═════╝░╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚══╝░╚═╝░╚═╝░░░░╚════╝░╚══════╝╚══════╝╚══════╝
     \033[0m██                                                                                                  ██
     \033[0m██         \033[96mCoded by: ! - Sakran#0111                                                                \033[0m██
     \033[0m██         \033[96mInstagram : https://instagram.com/u9t_n                                                  \033[0m██
     \033[0m██                                                                                                  ██
     \033[0m██████████████████████████████████████████████████████████████████████████████████████████████████████
                                         """
    print(logo)
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen("https://raw.githubusercontent.com/Sakoory/Anon-SMS/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen("https://raw.githubusercontent.com/Sakoory/Anon-SMS/master/.version").read().decode('utf-8')
verl = ''
try:
...
print('\n\tStarting Anon-SMS...\n')
try:
    noti = urllib.request.urlopen("https://raw.githubusercontent.com/Sakoory/Anon-SMS/master/.notify").read().decode('utf-8')
#    noti = print("""
